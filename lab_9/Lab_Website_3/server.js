...
app.get('/home/pick_color', function(req, res) {
	...
	var color_options =  'select name from favorite_colors where hex_value = \'color_choice\';'// Write a SQL query to retrieve the colors from the database
...
app.get('/team_stats', function(req, res) {
	...
	var winning = 'select count(*) from football_games where home_score>visitor_score;'
        var lossing = 'select count(*) from football_games where home_score<visitor_score;'
	db.task('get-everything', task => {
        return task.batch([
